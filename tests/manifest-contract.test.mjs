...
const dataHooks = [
  ...
  {
    name: "data-surface-feedback",
    selectors: [
      attributeSelector("data-surface-feedback", "error"),
      attributeSelector("data-surface-feedback", "success"),
      attributeSelector("data-surface-feedback", "attention"),
    ],
  },
  {
    name: "data-icon-role",
