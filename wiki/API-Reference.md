...
Interactive Surface CSS 1.7.1 is a CSS state primitive. It exports stylesheets and compatibility JavaScript entries, but it does not ship state-management or component-runtime behavior.
...
The preset and compatibility stylesheet are generated from the same authored modules and are behaviorally equivalent in 1.7.1.
