...
These instructions target the Interactive Surface CSS 1.7.2 release. Existing 1.x imports remain supported.
...
<link
  rel="stylesheet"
  href="https://unpkg.com/interactive-surface-css@1.7.2/standalone-preset.css"
/>
```
