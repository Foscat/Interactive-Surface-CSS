...
These instructions target the Interactive Surface CSS 1.7.1 release candidate. Existing 1.x imports remain supported.
...
<link
  rel="stylesheet"
  href="https://unpkg.com/interactive-surface-css@1.7.1/standalone-preset.css"
/>
```
